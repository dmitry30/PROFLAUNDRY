...
| Состояние позиции | Описание |
|-------------------|----------|
| Без ссылки на приёмку | Запланирована (из предварительного списка), ещё не обработана |
| Ссылается на приёмку | Добавлена прачкой в рамках конкретной сессии |
