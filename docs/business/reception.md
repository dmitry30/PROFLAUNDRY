...
Приёмка — это **сессия обработки**, а не контейнер данных. Подсчётные и расчётные позиции хранятся на уровне заказа и лишь ссылаются на приёмку, в которой были добавлены. Прачка при работе с приёмкой добавляет позиции в заказ.
